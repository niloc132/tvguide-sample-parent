package com.acme.gwt.attic.server;
...
public class PartnerLogin implements EntryPoint {
    ...
    idBox.addValueChangeHandler(new ValueChangeHandler<String>() {
      ...
      public void onValueChange(ValueChangeEvent<String> stringValueChangeEvent) {
        ...
        try {
          ...
          Log.warning(Arrays.toString(e.getStackTrace()));  //To change body of catch statement use File | Settings | File Templates.
        }
  ...
  static void renderDrillDown(final String oid, final String className, final String sid, final Panel flowPanel/*, final String tabTitle*/) {
    ...
    flowPanel.clear();
    flowPanel.add(panel);
    ModelProvider.App.getInstance().find(className, oid, sid, new AsyncCallback<Map<String, String>>() {
    ...
    doneButton.addClickHandler(new ClickHandler() {
      ...
      public void onClick(ClickEvent event) {
        ...
        if (!updateMap.isEmpty())
          ModelProvider.App.getInstance().merge(tabTitle, oid, updateMap, sid, new AsyncCallback<Boolean>() {
            @Override
            public void onFailure(Throwable caught) {
